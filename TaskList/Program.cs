...
namespace TaskList
{
    ...
    public static void AddTask(List<Job> tasks)
        {
    ...
    public static void DeleteTask(List<Job> tasks, bool goAgain)
        {
            foreach (Job t in tasks)
            {
                Console.WriteLine($"    {tasks.IndexOf(t) + 1}.Team Member: {t.Name}");
            ...
            {
                Console.WriteLine("Ok. Would you like to return to the main menu?");
                string goBack = Console.ReadLine().Trim().ToLower();
                if (goBack == "y"|| goBack == "yes")
                {
                    goAgain = true;
                }
                else
    ...
    public static void MarkComplete(List<Job> tasks)
        {
            JobList(tasks);
    ...
    public static void EditTask(List<Job> tasks, bool goAgain)
        {
